...
import com.example.androidtwelve.utils.PathUtils;
...
//            throw new Exception("文件类型非jpg或png");
//        }
    ...
    public String uploadOss(MultipartFile imgFile, String filePath){
        ...
        try {
//            InputStream inputStream = new FileInputStream("C:\\Users\\Administrator\\Desktop\\temp\\person.png");
            ...
            try {
                ...
                System.out.println("http://rvgc72vz1.hb-bkt.clouddn.com/" + key);
                return "http://rvgc72vz1.hb-bkt.clouddn.com/"+key;
